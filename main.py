...
size_canvas_x = 700
size_canvas_y = 700
s_x = s_y = 20 # размер игрового поля
s_y = 20
...
ship_len1 = s_x // 10  # длина первого типа корабля
ship_len2 = s_x // 5   # длина второго типа корабля
ship_len3 = s_x // 3  # длина третьего типа корабля
ship_len4 = s_x // 1  # длина четвертого корабля
...
# функция  показать корабли 1 игрока
...
# функция  показать корабли 2 игрока
...
# функция  начать заново игру(расставить все корабли заново)
...
# функция расстановки точек-кораблей(для первого)
def draw_point(x, y):
...
# функция расстановки точек-кораблей(для второго)
...
# функция проверка победы игрока второго
...
# добавление всех кораблей на поле
...
# функция создания вражеских кораблей
...
# print(enemy_ships2)
# print("****************************")
# функция запуска и работы приложения
while app_running:
    if app_running:
        tk.update_idletasks()
        tk.update()
